"""
Django settings for misty_smoke_39114 project.
...
ROOT_URLCONF = 'misty_smoke_39114.urls'
...
WSGI_APPLICATION = 'misty_smoke_39114.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_smoke_39114 API",
    "DESCRIPTION": "API documentation for misty_smoke_39114 App",
    "VERSION": "v1",
}
